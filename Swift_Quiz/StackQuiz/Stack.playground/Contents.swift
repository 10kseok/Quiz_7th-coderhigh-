...
struct Stack {
    ...
    func topItem() -> String? {
        ...
        let lastIndex = self.stackArray.count - 1
        return self.stackArray[lastIndex]
    }
    
    mutating func pop() -> String {
        // 방법 1 : popLast 메소드 사용
//        let lastOne = stackArray.popLast()
//        return lastOne!
        
        // 방법 2 : 어레이의 마지막 인덱스를 통해 마지막 값 삭제
        let lastIndex = self.stackArray.count - 1
        return stackArray.remove(at: lastIndex)
    }
}
